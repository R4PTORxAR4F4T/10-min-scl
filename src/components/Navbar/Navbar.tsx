...
const Navbar = () => {
    return (
        <div className=''>
            <div className="navbar bg-base-100 shadow-sm px-1 lg:px-12 text-gray-600 font-semibold justify-between">
                <div className="navbar-start">
                    ...
                    <li>
                        <details>
                        <summary>English Center</summary>
                        <ul className="p-2">
                            <li><a>Submenu 1</a></li>
                            <li><a>Submenu 2</a></li>
                        </ul>
                    ...
                    <img className='w-24' src="https://upload.wikimedia.org/wikipedia/commons/c/c3/10_Minute_School_Logo.svg" alt="" />
                    <button type='button' className='hidden md:flex ml-4 grid w-full grid-cols-[auto_1fr_auto] items-center gap-1 rounded-full px-4 py-2 text-left text-sm/6 text-black inset-ring inset-ring-gray-950/8 sm:w-80  dark:bg-white/5 dark:text-white/50 dark:inset-ring-black/20'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className="-ml-0.5 size-4 fill-gray-600 dark:fill-gray-500"><path fillRule="evenodd" d="M9.965 11.026a5 5 0 1 1 1.06-1.06l2.755 2.754a.75.75 0 1 1-1.06 1.06l-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" clipRule="evenodd"></path></svg>
                            Search Here
                    </button>
                ...
                <div className="ml-4 navbar-end flex gap-5 w-auto">
                    ...
                    <button className='items-center gap-1 text-green flex text-green-500'>
                        ...
                        <p className='hidden md:block'>16910</p>
                    </button>

                    <a className="px-3 py-1 text-white rounded-md bg-green-500 md:px-6">login</a>
                </div>
            </div>
        </div>   
    );
