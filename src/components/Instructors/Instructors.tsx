...
import { getTextFromHtml } from "../../utility/html-text";
...
const Instructors = ({instructors}) => {
  return (
    <div className="pt-4 pb-2 bg-white">
        ...
        <div className="flex items-center md:rounded-md md:border md:border-gray-300 md:p-5">
            <div>
                <div className="rounded-[50%] overflow-hidden opacity-0 transition-opacity duration-300 ease-in-out" style={{ fontSize: "0px", opacity: "1" }}>
                    <img
                    alt="Instructor Munzereen Shahid"
                    data-original-src="https://cdn.10minuteschool.com/images/skills/lp/ms_onset.jpg"
                    loading="lazy"
                    width="73"
                    height="73"
                    decoding="async"
            ...
            <div className="flex-1 ml-4">
                ...
                <div className="text-sm" dangerouslySetInnerHTML={{ __html: instructors.values[0].description }}>
                </div>
            </div>
        </div>
    </div>
